...
+ (UIColor*)mainBackgroundColor {return [UIColor colorWithHue:[AppColors primaryHue] saturation:[AppColors primarySaturation]*0.02 brightness:0.99 alpha:1];}
...
+ (UIColor*)lightTextColor {return [AppColors mainBackgroundColor];}
