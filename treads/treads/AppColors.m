...
+ (UIColor*)blankItemBackgroundColor {return [UIColor colorWithHue:[AppColors primaryHue] saturation:[AppColors primarySaturation]*0.5 brightness:[AppColors primaryValue]*0.15 alpha:1];}
